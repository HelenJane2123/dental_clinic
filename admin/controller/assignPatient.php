...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($doctor_id) && !empty($member_id)) {
        ...
        $current_assignment = $funObj->get_patient_details($patient_id);
        if ($current_assignment['assigned_doctor'] == $doctor_id) {
            $_SESSION['display_message'] = "The patient is already assigned to this doctor.";
