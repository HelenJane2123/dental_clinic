    ...
    <script>
        ...
        function addRow() {
            ...
            newRow.innerHTML = `
                ...
                <td><textarea name="dosage[]"  style="width: 250px; height: 200px; font-size: 16px; padding: 10px;" class="form-control"></textarea></td>
                <td><textarea name="instructions[]"  style="width: 250px; height: 200px; font-size: 16px; padding: 10px;" class="form-control"></textarea></td>
