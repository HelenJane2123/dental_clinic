...
<section class="ftco-section contact-section ftco-degree-bg">
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center"> <!-- Center the content horizontally -->
      ...
      <div class="col-md-6">
        <h2 class="h4 text-center mb-4">Forget Password Reset</h2> <!-- Centered heading -->

        <form action="controller/forgetPass.php" id="login_form" class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
          <?php 
          ...
          <div class="input-group form-group mt-3 input-box">
            ...
            <input type="text" class="form-control" placeholder="Enter your Email Address" name="email" required style="padding-left: 10px;"> <!-- Padding added to input -->
          </div>
          <!-- Login Button -->
          <div class="form-group mt-3">
            <div class="d-grid">
              <button class="btn btn-success"  name="reset_btn" type="submit">
                Send Reset Link
              </button>
            </div>
          </div>
